...
+ ## Intro(Linux共享库，静态库，动态链接库)
    ...
    ![](/.images/devops/build/gcc/lib/lib-01.png ':align=center')
    ...
    * ### 介绍
        ...
        linux中命名系统的共享库的规则
        <br>![](/.images/devops/build/gcc/lib/lib-02.png)

    * ### 代码实现

        ```c [data-file:libhello.c]
        ...
        <!-- tabs:start -->
        #### **[STATIC、SHARED]_sample**

        ```c [data-file:demo_use.c]
        ...
        gcc -g -shared -Wl,-soname,libhello.so.0  -o <mark class="clever">libhello.so.0.0</mark> libhello.o -lc
        ...
        # ln -sf libhello.so.0.0 <mark class="clever">libhello.so.0</mark>
        ...
        ln -sf libhello.so.0 <mark class="clever">libhello.so</mark>
        ...
        clang -g -dynamiclib -o <mark class="clever">libhello.dylib</mark> libhello.o -lc
