...
* ## redo日志格式
    ...
    <br><br>各个部分的详细释义如下：
    <br><span style='padding-left:1.2em'>type ：该条 redo 日志的类型。（在 MySQL 5.7.21 这个版本中，设计 InnoDB 的大叔一共为 redo 日志设计了 <span style='color:blue'>53</span> 种不同的类型，稍后会详细介绍不同类型的 redo 日志。)
    ...
    + ### 内部真实数据探索
        ...
        在插入`INSERT INTO record_format_demo(c1, c2, c3, c4) VALUES('12302', 'bbb', 'cc', 'd');`之前，通过`show engine innodb status\G` 获取 lsn(12327728)，之后再获取一次 lsn(12327974)。
        <br>此时就可以通过工具[redo_reader](https://github.com/ddcw/redo.git) 解析当前语句大概生成了哪些 redo 日志。如下输出：

        <details><summary>解析 redo 输出</summary>

        ```shell {68}
        /Library/Frameworks/Python.framework/Versions/3.10/bin/python3 /Users/stevenobelia/Documents/project_pycharm_test/redo/redo_reader.py --start-lsn 12327728 --stop-lsn 12327974 -V /tmp/mysql/ib_logfile0 
        /tmp/mysql/ib_logfile0:
            name                          : ib_logfile0
            filesize                      : 50331648
            filename                      : /tmp/mysql/ib_logfile0
            LOG_HEADER_FORMAT             : 1
            LOG_HEADER_PAD1               : 0
            LOG_HEADER_START_LSN          : 8704
            LOG_HEADER_LOG_UUID           : 0
            LOG_HEADER_STOP_LSN           : 50340352
            LOG_HEADER_CREATOR            : MySQL 5.7.21
            LOG_CHECKPOINT1_NO            : 14
            LOG_CHECKPOINT1_LSN           : 12327965
            LOG_CHECKPOINT1_OFFSET        : 12321309
            LOG_CHECKPOINT1_LOG_BUF_SIZE  : 16777216
            LOG_CHECKPOINT2_NO            : 13
            LOG_CHECKPOINT2_LSN           : 12327904
            LOG_CHECKPOINT2_OFFSET        : 12321248
            LOG_CHECKPOINT2_LOG_BUF_SIZE  : 16777216
        ...
        - [S] file:ib_logfile0 gblockno:2147507726 lsn:12327728 cblockno:24064 offset:304 name:MLOG_8BYTES(8)
            spaceno   : 0
            pageno    : 7
            offset    : 38
            value     : 768
        
        - [M] file:ib_logfile0 gblockno:2147507726 lsn:12327738 cblockno:24064 offset:314 name:MLOG_UNDO_HDR_REUSE(24)
            spaceno   : 0
            pageno    : 280
            trx_id    : 2308
        
          [M] file:ib_logfile0 gblockno:2147507726 lsn:12327747 cblockno:24064 offset:323 name:MLOG_2BYTES(2)
            spaceno   : 0
            pageno    : 280
            offset    : 40
            value     : 272
        
          [M] file:ib_logfile0 gblockno:2147507726 lsn:12327755 cblockno:24064 offset:331 name:MLOG_2BYTES(2)
            spaceno   : 0
            pageno    : 280
            offset    : 42
            value     : 272
        
          [M] file:ib_logfile0 gblockno:2147507726 lsn:12327763 cblockno:24064 offset:339 name:MLOG_2BYTES(2)
            spaceno   : 0
            pageno    : 280
            offset    : 104
            value     : 272
        
          [M] file:ib_logfile0 gblockno:2147507726 lsn:12327771 cblockno:24064 offset:347 name:MLOG_MULTI_REC_END(31)
            spaceno   : -1
            pageno    : -1
        
        - [S] file:ib_logfile0 gblockno:2147507726 lsn:12327772 cblockno:24064 offset:348 name:MLOG_UNDO_INSERT(20)
            spaceno   : 0
            pageno    : 280
            len       : 10
            data      : b'\x0b\x00,\x06\x00\x00\x00\x00\x03\x00'
        05 00 00 00 28 ff 71 00 00 00 00 03 00 00 00 00 00 09 04 a4 00 00 01 18 01 10 31 32 33 30 32 62 62 62 63 63 20 20 20 20 20 20 20 20 64
        
        - [M] file:ib_logfile0 gblockno:2147507726 lsn:12327788 cblockno:24064 offset:364 name:MLOG_COMP_REC_INSERT_8027(38)
            spaceno   : 24
            pageno    : 3
            n         : 7
            n_uniq    : 1
            col       : [32774, 32774, 32775, 0, 32768, 10, 0]
            offset    : 209
            end_seg_len: 45
            info_and_status_bits: 0
            origin_offset: 9
            mismatch_index: 2
            data      : b'\x05\x00\x00\x00(\xffq\x00\x00\x00\x00\x03\x00\x00\x00\x00\x00\t\x04\xa4\x00\x00\x01\x18\x01\x1012302bbbcc        d'
        
          [M] file:ib_logfile0 gblockno:2147507726 lsn:12327860 cblockno:24064 offset:436 name:MLOG_FILE_NAME(55)
            spaceno   : 24
            pageno    : 0
            mlen      : 31
            mname     : b'./demos/record_format_demo.ibd\x00'
        
          [M] file:ib_logfile0 gblockno:2147507726 lsn:12327896 cblockno:24064 offset:472 name:MLOG_MULTI_REC_END(31)
            spaceno   : -1
            pageno    : -1
        
        - [S] file:ib_logfile0 gblockno:2147507726 lsn:12327897 cblockno:24064 offset:473 name:MLOG_2BYTES(2)
            spaceno   : 0
            pageno    : 280
            offset    : 56
            value     : 2
        
        - [S] file:ib_logfile0 gblockno:2147507726 lsn:12327904 cblockno:24064 offset:480 name:MLOG_FILE_NAME(55)
            spaceno   : 24
            pageno    : 0
            mlen      : 31
            mname     : b'./demos/record_format_demo.ibd\x00'
        
        - [M] file:ib_logfile0 gblockno:2147507727 lsn:12327956 cblockno:24065 offset:020 name:MLOG_CHECKPOINT(56)
            spaceno   : -1
            pageno    : -1
            lsn       : 12327904
        
          [M] file:ib_logfile0 gblockno:2147507727 lsn:12327965 cblockno:24065 offset:029 name:MLOG_CHECKPOINT(56)
            spaceno   : -1
            pageno    : -1
            lsn       : 12327965
        ...
        <!-- tabs:start -->
        ##### **当前**
        ![](/.images/doc/framework/mysql/book/20_redo-01/rd-05-02.png ':size=88%')
        ##### **第一次记录**
        ![](/.images/doc/framework/mysql/book/20_redo-01/rd-05-01.png ':size=80%')
        <!-- tabs:end -->
