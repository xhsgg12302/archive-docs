...
* ## Example
    ...
    + ### 02-markdown语法
        ...
        - #### 2). 下面表格的形式展示各种小文本块
            ...
            | 上标：X<sub>2</sub> | 下标：O<sup>2</sup> | `文本块2` | ![favicon.ico](/.images/_media/national-emblem.png ":size=10%") | |
            | ---- | :----- | :-------: | ----------: | ---------------- |
            | **粗体1**   | __加粗2__    |  _斜体1_     |    *斜体2* |    |
            | ~~删除线1~~   | <s>删除线2</s>   |   ___斜体加粗1___    |   ***斜体加粗2*** | ~~_删除斜体线_~~ |
            | [特殊符号](https://tw.piliapp.com/symbol/) | duihao，duigou，绿对号，对勾 ✅ | cuohao，chahao，错号，红叉号 ❌ | yuanquan，圆，红圆圈，⭕️ |  |
